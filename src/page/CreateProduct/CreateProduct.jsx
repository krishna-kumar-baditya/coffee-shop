...
import { insertProduct } from "../../Redux/Slice/productSlice";
...
function CreateProductForm() {
    ...
    const { loading, error } = useSelector((state) => state.prodKey);

    // File validation constants
    const allowedTypes = ["image/png", "image/jpg", "image/jpeg"];
    const MAX_FILE_SIZE = 5 * 1024 * 1024; // 5MB

    // State for image preview and URL
    ...
    const handleImageChange = (e) => {
        ...
        if (!allowedTypes.includes(file.type)) {
            toast.error("Invalid format. Only JPG, JPEG, PNG allowed.");
            e.target.value = "";
            return;
        }
        ...
        currentImageRef.current = URL.createObjectURL(file);
        setImagePreview(currentImageRef.current);
        ...
        return (
            <Dashboard>
                <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-amber-100 p-4 flex items-center justify-center">
                    <p className="text-amber-800">Creating product...</p>
                </div>
            </Dashboard>
        );
    }
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-2 text-amber-700">
                                Add a new coffee offering to your store
                            </p>
                        </div>
