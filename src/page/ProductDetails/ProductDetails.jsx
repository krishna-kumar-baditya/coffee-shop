    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white py-8 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-6">
                    <nav
                        className="flex text-sm text-amber-600"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    <div className="flex justify-center lg:justify-start">
                        <div className="relative bg-white p-6 rounded-3xl shadow-lg max-w-md w-full">
                            ...
                            <div className="w-full bg-gradient-to-br from-amber-100 to-amber-200 flex items-center justify-center rounded-2xl">
                                {/* <ima className="text-8xl text-amber-400">{}</ima> */}
                                <img
                                    src={specificProducts.image}
                                    alt="product-img"
                                    className=""
                                />
                            </div>
                    ...
                    <div className="flex flex-col justify-center">
                            ...
                            {specificProducts.discountPrice > 0 ? (
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-xl text-amber-500 line-through">
                                        ₹
                                        {specificProducts.discountPrice.toFixed(
                                            2,
                                        )}
                                    </span>
                                </div>
                        ...
                        {/* Features / Highlights */}
                        {specificProducts.highlights &&
                            specificProducts.highlights.length > 0 && (
                                <div className="mt-8">
                                    <h3 className="text-xl font-semibold text-amber-900 mb-3">
                                        Why You’ll Love It
                                    </h3>
                                    <ul className="space-y-2">
                                        {specificProducts.highlights.map(
                                            (highlight, index) => (
                                                <li
                                                    key={index}
              ...
              {isProductInCart(specificProducts._id) ? (
                <div className="flex items-center gap-4 bg-amber-50 border-2 border-amber-300 rounded-2xl px-6 py-4">
                  <button
                    onClick={() => handleDecrement(specificProducts._id)}
                    className="p-2 text-amber-700 hover:text-amber-900 hover:bg-amber-200 rounded-lg transition-colors"
                  ...
                  <span className="text-amber-900 font-bold text-lg min-w-[40px] text-center">
                    {getCartItemQuantity(specificProducts._id)}
                  </span>
                  <button
                    onClick={() => handleIncrement(specificProducts._id)}
                    className="p-2 text-amber-700 hover:text-amber-900 hover:bg-amber-200 rounded-lg transition-colors"
                ...
                <button
                  onClick={() => handleAddToCart(specificProducts)}
                  className="py-4 px-6 bg-amber-900 text-white font-bold text-lg rounded-2xl hover:bg-amber-800 transform hover:scale-[1.02] transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-amber-300"
                >
                  Add to Cart
                </button>
              )}
                        ...
                        <div className="mt-10">
                            <button
                                onClick={() =>
                                    handleAddToCart(specificProducts)
                                }
                                className="w-full sm:w-auto px-8 py-4 bg-amber-900 text-white text-lg font-bold rounded-2xl hover:bg-amber-800 transition"
                            >
                                Add to Cart
                            </button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <p className="text-amber-700 leading-relaxed">
                                Best brewed as espresso, pour-over, or French
                                press. Grind fresh before brewing for maximum
                                aroma and flavor.
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-amber-700 leading-relaxed">
                                Sourced from high-altitude farms in Colombia.
                                Flavor notes: chocolate, caramel, and a hint of
                                citrus.
                            </p>
                        </div>
                    </div>
